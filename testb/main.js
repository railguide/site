     ...
     *   hoverFields: array of property keys for hover (e.g. ["name","title","description"])
     *   popupFields: array of property keys for popup (e.g. ["name","title","description","url"])
     *   hoverMaxChars: max total characters in hover (0 = no limit). Example: 80
     *   hoverMaxLines: max lines (fields) in hover (0 = no limit). Example: 3
     *   popupMaxCharsPerField: max chars per field in popup (0 = no limit). Example: 120
     */
    var HOVER_POPUP_CONFIG = {
        0: { hoverFields: ["rr_full", "rg_name"], popupFields: ["rr_full", "rg_name", "sub_title", "rg_desc"] },
        1: { hoverFields: ["rg_name", "sub_title"], popupFields: ["rg_name", "sub_title", "rg_desc"] },
        2: { hoverFields: ["classic_full", "rg_name", "sub_title", "rg_desc"], popupFields: ["classic_full", "rg_name", "sub_title", "rg_desc"] },
        3: { hoverFields: ["rr_full", "classic_full", "rg_name", "rg_desc"], popupFields: ["rr_full", "classic_full", "rg_name", "sub_title", "rg_desc"] },
        4: { hoverFields: ["rr_full", "classic_full", "rg_name", "sub_title"], popupFields: ["rr_full", "classic_full", "rg_name", "sub_title", "rg_desc"] },
    ...
    class handleMapPrcoessCreation {
        ...
        addControl () {
            ...
            /* Attribution: © RailGuide as link to home */
        ...
        addEvents () {
            ...
            this.map.on("click", function (e) {
                ...
                if (feature && label && String(label).trim()) {
                    ...
                    var cfg = HOVER_POPUP_CONFIG[base.currentStyleIndex] || {};
                    var popupBody = buildPopupHtml(feature.properties, { fieldKeys: cfg.popupFields, maxCharsPerField: cfg.popupMaxCharsPerField });
